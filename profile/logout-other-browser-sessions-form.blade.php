<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Disini kamu akan bisa lihat siapa saja yang login, dan dari device apa saja dia login') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Jika anda merasa tidak yakin dengan device ini anda bisa mengklik tombol logout feel free untuk logout secara paksa') }}
        </div>
